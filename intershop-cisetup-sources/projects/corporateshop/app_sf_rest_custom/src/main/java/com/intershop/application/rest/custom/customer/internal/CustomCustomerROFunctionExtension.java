...
/**
 * Adds customer custom attributes to the customer REST response as custom fields.
 */
abstract class CustomCustomerROFunctionExtension<T extends CustomerRO>
    implements FunctionExtension<CustomerBO, T>
{
    private static final String[] ATTRIBUTE_NAMES =
        { "ShowBackInStockDate", "DefaultCurrency", "HideInvoiceDocument", "newsletter"};
    ...
    protected CustomerSegmentBORepository getSegmentRepository()
    {
        ...
        BusinessObjectRepositoryContext repositories =
            appContext == null ? null : appContext.getVariable(BusinessObjectRepositoryContext.CURRENT);

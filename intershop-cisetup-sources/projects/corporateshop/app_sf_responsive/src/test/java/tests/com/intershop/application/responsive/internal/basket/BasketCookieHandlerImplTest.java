...
public class BasketCookieHandlerImplTest
{
    ...
    @InjectMocks
    private final BasketCookieHandler handler = new BasketCookieHandlerImpl();

    @Before
    public void initBasketBO()
    {
        when(basketBO.getID()).thenReturn(BASKET_ID);
        when(repository.getActiveBasketBO(eq(BASKET_ID))).thenReturn(basketBO);
    ...
    public void testGetBasketBOFromCookie_NoRequest()
    {
        ...
        Assert.assertThrows(IllegalStateException.class, () -> handler.getBasketBOFromCookie(repository));
    }
    ...
    public void testCreateCookie_NoRequest()
    {
        ...
        Assert.assertThrows(IllegalStateException.class, () -> handler.createCookie(basketBO));
    }
    ...
    public void testRemoveCookie_NoRequest()
    {
        ...
        Assert.assertThrows(IllegalStateException.class, () -> handler.removeCookie(repository));
    }
    ...
    {
        Answer<T> returnValueOrDefault = invocation -> value != null ? value : invocation.getArgument(1);

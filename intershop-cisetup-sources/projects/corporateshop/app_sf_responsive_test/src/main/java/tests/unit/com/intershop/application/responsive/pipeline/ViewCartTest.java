...
{    
    ...
    public void testGetCurrentCartBOByUserWithAnonymousUser() throws Exception
    {
        ...
        BasketPO basketPO = mock(BasketPO.class);
        when(ext.getPersistentObject()).thenReturn(basketPO);
        ...
        when(basketPO.tryLock(2000)).thenReturn(true);

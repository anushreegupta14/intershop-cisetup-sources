...
{
    static url= StorefrontPage.url + "ViewProduct-Start";
    ...
    def setRetailSetQuantity(productsku, quantity) {
        $("input", type:"number", id:"Quantity_"+productsku).value quantity
    }
    ...
    {
        addProductButton.click()
        waitFor { header.miniCartLink.displayed }
    }
}

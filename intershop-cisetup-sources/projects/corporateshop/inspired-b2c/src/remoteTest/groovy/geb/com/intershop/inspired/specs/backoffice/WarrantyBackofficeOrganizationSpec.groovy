...
class WarrantyBackofficeOrganizationSpec extends GebReportingSpec implements TestDataUsage
{
    ...
    {   
        ...
        navigateToMainMenuItem "bo-sitenavbar-catalogs-organization", "link-catalogs-products-organization"

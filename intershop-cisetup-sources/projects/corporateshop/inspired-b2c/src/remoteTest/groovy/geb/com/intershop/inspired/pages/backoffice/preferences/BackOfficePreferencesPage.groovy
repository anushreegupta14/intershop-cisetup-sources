...
import geb.com.intershop.inspired.pages.backoffice.preferences.CaptchaPreferencesPage
...
import geb.com.intershop.inspired.pages.backoffice.channels.PreferencesSEOSettingsPage
...
//        SEOPreferences(required: true, to: PreferencesSEOSettingsPage) { $('a', 'data-testing-class': 'link-preferences-seo-channel') }

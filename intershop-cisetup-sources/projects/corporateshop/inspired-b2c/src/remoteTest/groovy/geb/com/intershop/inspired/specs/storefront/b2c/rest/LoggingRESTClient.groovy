...
class LoggingRESTClient extends RESTClient
{
    ...
    public Object get(Map args, Closure responseClosure) {
        super.get(args, responseClosure)
    }
    ...
    public Object executeRequest(HttpMethod method, Map args)
    {
    ...
    public void logRequest(Map args, HttpMethod method)
    {
    ...
    public int getPort(String portValue)
    {
